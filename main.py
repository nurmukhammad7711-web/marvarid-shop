...
# ----------------- 2. FastAPI ИЛОВАСИНИ ЯРАТИШ (Муҳим кетма-кетлик) -----------------
app = FastAPI()
...
# Вақтинчалик админ суҳбат ҳолатини сақлаш
user_states = {}
...
# ----------------- 4. TELEGRAM BOT: АДМИН ПАНЕЛ ВА РОЛЛАР -----------------
...
# ----------------- 5. БОТНИ АЛОҲИДА ОҚИМДА ИШГА ТУШИРИШ (Polling) -----------------
def run_bot():
    try:
        bot.remove_webhook()
        time.sleep(1)
